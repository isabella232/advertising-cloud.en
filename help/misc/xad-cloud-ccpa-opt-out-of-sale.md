...
1. Locate the new segment in the Segment Manager list, click ![Options menu](/help/misc/assets/edit-menu.png) in the Options column, and then select **get pixel**. <!-- I should be able add hover text in the image link, such as (x.png "hover text"), but either it's not currently supported or it's broken -->
