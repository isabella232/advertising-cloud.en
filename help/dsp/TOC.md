...
+ Campaign Management {#campaign-management}
  ...
  + Ads {#ads}
    ...
    (https://experienceleague.adobe.com/docs/advertising-cloud/dsp/campaign-management/placements/ad-attach-to-placement.html)<!-- Dupe link to this file, so need to use an absolute link in one of the listings -->
