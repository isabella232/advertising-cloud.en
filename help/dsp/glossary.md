...
*Black list*
Websites and inventory that ads are not permitted to be shown on
...
*Cost Per Action (CPA)*
Clients only pay when a viewer performs an agreed upon action (such as clicks or social engagement). This pricing model is used interchangeably with cost per click (CPC) and cost per engagement (CPE).
...
*Endcap*
An eye-catching image or Flash that appears at the end of a video ad
...
A performance metric used to evaluate the success of a particular ad or campaign. These can be quantitative, such as impressions, clicks, social actions or qualitative in the case of brand metrics (i.e. awareness, purchase intent, brand lift).
