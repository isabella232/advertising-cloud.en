...
| Low spend on placement | The Non Bids section of the placement diagnostics report shows possible reasons for why the placement didn't bid. | Review the Non Bids report <!-- How do you open it? --> to understand why the placement didn't bid. To open the report, open the placement settings, click ![Placement Diagnostics](/help/dsp/assets/placement-diagnostics.png) in the upper right, and then click **Non Bids** in the upper right of the Diagnostics report.  <!-- add link/edit text when file available: See the [in-depth guide to possible Non-Bid Reasons (NBR)](link) for more information. --> |
