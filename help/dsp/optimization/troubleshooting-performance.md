...
| | The budget goal has been met and/or isn't high enough. | Check the budget settings at the campaign, package, and placement levels. <!-- Something more specific than "correctly set up?" Would you want to adjust them in some way? Probably some clients have set budgets and won't want to increase the total? --> |
...
| Low spend on placement | The Non Bids tab in the placement diagnostics report shows possible reasons for why the placement didn't bid. | Review the Non Bids report <!-- How do you open it? --> to understand why the placement didn't bid. <!-- add link/edit text when file available: See the [in-depth guide to possible Non-Bid Reasons (NBR)](link) for more information. --> |
